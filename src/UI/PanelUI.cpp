...
void Nya::PanelUI::set_panelText(std::string string){
    text->set_text(string);
}

Nya::PanelUI::PanelUI(UnityEngine::Transform* parent, UnityEngine::Sprite* sprite, int index){
    ...
    image->set_material(Nya::Main::NyaFloatingUI->UINoGlow);
